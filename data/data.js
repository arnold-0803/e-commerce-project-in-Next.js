import { faCarAlt, faEarthAfrica, faPeopleRoof, faScrewdriverWrench} from '@fortawesome/free-solid-svg-icons';
// NAVBAR DATA
...
export const achievementData = [
  {id: 0, start: 0, end: 1000, icon: faPeopleRoof, symbol: "+", description: "Impacted in the Community"},
  {id: 1, start: 0, end: 25, icon: faEarthAfrica, symbol: "", description: "Network in the Country"},
  {id: 2, start: 0, end: 1000, icon: faCarAlt, symbol: "+", description: "Sold Both locally & EA"},
  {id: 3, start: 0, end: 75, icon: faScrewdriverWrench, symbol: "%", description: "Happy Customers"}
];
...
export const QuestionAndAnswer = [
  {
    ...
    answer: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum ea dolores beatae, ut illum tenetur, ipsa ratione doloribus eveniet assumenda est hic accusantium neque, ad reprehenderit necessitatibus praesentium impedit repudiandae! Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci deserunt non dolore aliquam aperiam, reiciendis inventore quibusdam laboriosam repellendus animi. Quisquam laborum neque atque, magnam maiores quam dolorum ullam vitae."
  },
  {
    id: 1,
    question: "Lorem ipsum dolor sit amet consectetur, adipisicing elit?",
...
export const ContactBannerData = [
  {
    ...
    offPercentage: "50%",
    paragraphOne: "On All Sales Evrey Friday, this Has Always Been Our Culture to Remember Black-Friday as a Way of Bringing Promotions to Our Esteemed Customers",
    paragraphTwo: "We don't sell cheaper products, we sell affordable and quality product to our customers and also help you put your cash into good use this because we believe cheap is expensive. We are your trusted car body kits dealer in town, when you shop with us will never regrate it!"
  }
]
